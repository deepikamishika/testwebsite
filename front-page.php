                ...
                <ul class="slides scroll">
                    <li class="first">
                        <div class="slider-text-wrapper">  
                            <div class="container">
                                <div class="big">We Are Creative And </br>Professional Studio Agency </div>          
                                <div class="small">Are you ready to try once.</div>
                    ...
                    <li class="secondary">
                        <div class="slider-text-wrapper"> 
                            <div class="container">                       
                                <div class="big">We Provide Best Professional Services </div>          
                                <div class="small">Quality Products |
Custom Products |
Online Order |
Home Delivery</div>
                                <a href="#works" class=" middle btn btn-white">VIEW PORTFOLIO</a>
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/slider/2.jpg" alt="">
                    </li>
                    
                    <li class="third">
                        <div class="slider-text-wrapper"> 
                            <div class="container">                              
                                <div class="big">Discover Our Unique </br>And Creative Photoshoot </div>          
                                <div class="small">Quality Products |
Custom Products |
Online Order |
Home Delivery</div>
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/slider/3.jpg" alt="">
                    </li>
                </ul>
            </div>
        </section>
   ...
   <section id="works" class="section">
                  ...
                  <div class="title-box text-center">
					...
					<div class=" col-md-12 text-center">
						...
						<ul class="filtering">
                            ...
                            <li class="filter" data-filter="Natural">  Natural</li>
				...
				<div class="work-main">
					...
					<ul class="work-grid">
						...
						<li class="work-item thumnail-img mix corporate">
							<div class="work-image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/works/img3.jpg" alt="thumbnail">
                                 ...
                                 <!--Hover link-->
                                 <div class="hover-link">
                                   <a href="<?php echo get_template_directory_uri(); ?>/assets/single-work.html">
                                        <i class="fa fa-link"></i>
                                    </a>
						...
						<li class="work-item thumnail-img mix event">
							<div class="work-image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/works/img9.jpg" alt="thumbnail">
                                 ...
                                 <!--Hover Caption-->
                                 <div class="<?php echo get_template_directory_uri(); ?>/assets/work-caption">
                                     <h4>Project Title</h4>
                                     <p>Photography</p>
                                 </div>
                                 <!--End Caption-->
						...
						<!-- Work Item -->
						<li class="<?php echo get_template_directory_uri(); ?>/assets/work-item thumnail-img mix corporate">
							<div class="work-image">
